...
public class CheckHotels extends JFrame implements ActionListener {
    ...
    public void run() {
        try {
            // Sequence of images with captions
            l2.setVisible(true);
    ...
    public CheckHotels()
    {
        ...
        JLabel label = new JLabel("Hotel Info Displayed Here");
        ...
        th = new Thread(String.valueOf(this));
        ...
        // Load and display hotel images with proper paths and scaling
    ...
    public static void main(String args[]) {
        // Using EventQueue to ensure proper initialization of UI components
    ...
    public void actionPerformed(ActionEvent e)
    {
        try {
            ...
            ex.printStackTrace(); // Helps catch any hidden errors
        }
