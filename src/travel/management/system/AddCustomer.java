...
public abstract class AddCustomer extends JFrame implements ActionListener
{
    ...
    public AddCustomer(String username) throws SQLException
    {
        ...
        JLabel address1 = new JLabel("Permanent Address :");
        address1.setBounds(35, 310, 200, 14);
